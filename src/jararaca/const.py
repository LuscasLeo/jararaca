...
OBSERVABILITY_TRACE_SPAN_HTTP_RESPONSE_MAX_BODY_SIZE_ATTRIBUTE_VALUE: int = get_env_int(
    "JARARACA_OBSERVABILITY_TRACE_SPAN_HTTP_RESPONSE_MAX_BODY_SIZE_ATTRIBUTE_VALUE",
    default=5000,  # 5KB
)
